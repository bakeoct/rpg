...
//
//    public int attack(Monster hp_monster, Monster attack_monster) {
//        int up_attack = 0;
//        int up_defence = 0;
//        try {
...
//    }
//    */
//    public void choose_skill(Monster monster2, LinearLayout battle_chat, ImageView monster_of_player, ImageView enemy_monster, TextView battle_chat_text, ImageView effect, Resources resources, FrameLayout frame_layout_player, FrameLayout frame_layout_monster, FrameLayout frame_layout_throw, ImageView fight_button, ImageView item_button, ImageView run_button, ImageView finish_button, FrameLayout frame_layout_player_power_up, FrameLayout frame_layout_monster_power_up, ArrayList<ArrayList<ProgressBar>> ber_gauge, ArrayList<ArrayList<TextView>> text_gauge) {
//        //敵モンスターと味方モンスターの戦い
...
//        return percent;
//    }
//    public boolean setPlayerFirst(boolean sente, Monster monster) {
...
//    }
//
//    public void battle(Monster monster2, LinearLayout battle_chat, ImageView monster_of_player, ImageView enemy_monster, TextView battle_chat_text, ImageView effect, Resources resources, FrameLayout frame_layout_player, FrameLayout frame_layout_monster, FrameLayout frame_layout_throw, ImageView fight_button, ImageView item_button, ImageView run_button, ImageView finish_button, FrameLayout frame_layout_player_power_up, FrameLayout frame_layout_monster_power_up, ArrayList<ArrayList<ProgressBar>> ber_gauge, ArrayList<ArrayList<TextView>> text_gauge) {
...
//    }
//
//    public void alive(LinearLayout battle_chat, TextView battle_chat_text, Monster monster2) {
...
//        }
//    }
//    public int useItem(Monster my_side_monster, LinearLayout battle_chat, TextView battle_chat_text, FrameLayout frame_layout_player_power_up, ImageView effect, Resources resources){
...
//                    battle_chat.removeAllViews();
//                    battle_chat_text.setTextColor(Color.RED);
//                    battle_chat_text.setText(game.player.fight_items.get(battle_chat_i).name+"を使った！");
//                    battle_chat.addView(battle_chat_text);
//                    game.player.choose_item = battle_chat_i;
//                    game.player.fight_items.get(game.player.choose_item).have_point--;
//                    useItemMath(my_side_monster);
//                    battle_manager_activity.drawGraphicUsingItem(effect,frame_layout_player_power_up,resources);
//                    if (game.player.fight_items.get(game.player.choose_item).have_point == 0){
//                        game.player.items.remove(game.player.fight_items.get(game.player.choose_item));
//                        game.player.fight_items.remove(game.player.choose_item);
//                    }
//                }
//            });
//            }
...
//        for (FightItem fightItem : game.player.fight_items) {
//            battle_chat_text.setTextColor(Color.RED);
//            battle_chat_text.setText(fightItem.name + " " + fightItem.have_point + "個 ");
//            battle_chat.addView(battle_chat_text);
//        }
//    }
//    public void useItemMath(Monster monster2){
//        if (game.player.fight_items.get(game.player.choose_item).item_group.equals("heal")){
//            if (monster2.limit_hp > monster2.hp + game.player.fight_items.get(game.player.choose_item).heal){
//                monster2.hp += game.player.fight_items.get(game.player.choose_item).heal;
//            }else {
