...
public class Cave1Activity extends MapActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        control_key.do_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (cave_1_activity.map[game.player.mpy][game.player.mpx].equals("cave1_1")){
                    goCave1_1();
                }else if (cave_1_activity.map[game.player.mpy][game.player.mpx].equals("back_world_cave")){
                    goMainMap();
                }
            }
        });
    ...
    public void goCave1_1(){
        game.player.mpx = CAVE1_1_INITIAL_X;
        game.player.mpy = CAVE1_1_INITIAL_Y;
        game.player.serve_mpx = CAVE1_1_INITIAL_X;
        game.player.serve_mpy = CAVE1_1_INITIAL_Y;
    ...
    public void goMainMap(){
        game.player.mpx = CAVE1_BACK_MAIN_WORLD_INITIAL_X;
        game.player.mpy = CAVE1_BACK_MAIN_WORLD_INITIAL_Y;
        game.player.serve_mpx = CAVE1_BACK_MAIN_WORLD_INITIAL_X;
        game.player.serve_mpy = CAVE1_BACK_MAIN_WORLD_INITIAL_Y;
        Intent intent = new Intent(Cave1Activity.this, TransitionActivity.class);
        startActivity(intent);
        overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
