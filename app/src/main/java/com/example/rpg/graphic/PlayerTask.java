...
//            damage_monster.setImageDrawable(resources.getDrawable(game.get_enemy_monster.monster_drawable[1]));
//            effect.setImageDrawable(resources.getDrawable(R.drawable.invisible_panel));
...
//        handler.postDelayed(() ->{
//            if (my_side_monster_number < game.player.monsters2.size() - 1) {
//                my_side_monster_number++;
//                die_ally_monster.setRotation(default_rotation);
//                default_rotation = 0;
//                die_ally_monster.setImageDrawable(resources.getDrawable(game.player.monsters2.get(my_side_monster_number).monster_drawable[2]));
//                ber_gauge.get(0).get(0).setProgress((int)setPercent(game.player.monsters2.get(my_side_monster_number).hp,game.player.monsters2.get(my_side_monster_number).limit_hp));
//                text_gauge.get(0).get(0).setText(game.player.monsters2.get(my_side_monster_number).hp+"/"+game.player.monsters2.get(my_side_monster_number).limit_hp);
//                ber_gauge.get(0).get(1).setProgress((int)setPercent(game.player.monsters2.get(my_side_monster_number).mp,game.player.monsters2.get(my_side_monster_number).limit_mp));
//                text_gauge.get(0).get(1).setText(game.player.monsters2.get(my_side_monster_number).mp+"/"+game.player.monsters2.get(my_side_monster_number).limit_mp);
//                fight_button.setVisibility(View.VISIBLE);
//                item_button.setVisibility(View.VISIBLE);
//                run_button.setVisibility(View.VISIBLE);
//            }else {
