...
public class PlayerTask implements AnimationTask{
    ...
    public void damageEffect(Runnable onComplete){
        ...
        ber_gauge.get(0).get(0).setProgress((int)setPercent(game.get_enemey_monster.hp,game.get_enemey_monster.limit_hp));
        text_gauge.get(0).get(0).setText(game.get_enemey_monster.hp+"/"+game.get_enemey_monster.limit_hp);
        ber_gauge.get(1).get(1).setProgress((int)setPercent(monster.mp,monster.limit_mp));
        text_gauge.get(1).get(1).setText(monster.mp+"/"+monster.limit_mp);
        handler.postDelayed(() -> {
